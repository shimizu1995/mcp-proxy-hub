...
Values above the maximum safe `setTimeout` delay (`2147483647` ms) are capped. Invalid values (negative, `NaN`, non-number) fall through to the next level with a warning.
